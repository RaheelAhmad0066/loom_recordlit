                    ...
                    <div className="hidden lg:block animate-fade-in-up">
                        <div className="space-y-8">
                            <div className="flex items-center gap-3">
                                <img src="/logo.png" alt="Recordly Logo" className="w-16 h-16 object-contain" />
                                <div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-[hsl(var(--card))] rounded-2xl shadow-2xl border border-[hsl(var(--border))] p-8 md:p-10">
                                ...
                                <div className="lg:hidden flex items-center gap-3 mb-8">
                                    <img src="/logo.png" alt="Recordly Logo" className="w-14 h-14 object-contain" />
                                    <span className="text-2xl font-bold text-[hsl(var(--foreground))] tracking-tighter">Record<span className="text-gradient">ly</span></span>
                                </div>
                                ...
                                {isSafari ? (
                                    /* Apple Sign In Button (Strictly for Safari) */
                                    <button
                                        onClick={handleAppleSignIn}
                                        disabled={loading}
                                        className="w-full group relative overflow-hidden bg-black border-2 border-black hover:bg-zinc-900 rounded-xl p-4 transition-all duration-300 shadow-sm hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <div className="flex items-center justify-center gap-3 text-white">
                                            {loading ? (
                                                ...
                                                <>
                                                    <svg className="w-6 h-6 flex-shrink-0 fill-current" viewBox="0 0 384 512">
                                    ...
                                    /* Google Sign In Button (Strictly for non-Safari) */
                                    <button
